<div class="fontview_custom customization_block animated zoom" ng-if="screencustom.view_type == 'front'">
    ...
    <img src="<?php echo custome_image_server; ?>/shirt/overlay/buttons.png" class="fixpos animated" ng-if="selecteElements[fab.product_id]['Cuff & Sleeve'].french == '0'"  >
...
<div class="backview_custom customization_block  animated " ng-if="screencustom.view_type == 'back'" >
    ...
    <img src="<?php echo custome_image_server; ?>/shirt/output/{{screencustom.productobj.folder}}/back_collar0001.png" class="fixpos animated" >
