                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="tab-content">
                                                ...
                                                if (PAYMENT_MODE_PAYPAL == 'on') {
                                                    ?>
                                                    <div class="  <?php echo DEFAULT_PAYMENT_MODE == 'PayPal' ? 'active in' : ''; ?>"  id="paypal">
                                                        <p>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="text_right">
                                                                            <div class="proceed-button pull-left " >
                                                                                <a href=" <?php echo site_url("Cart".$checkoutmode."/checkoutShipping"); ?>" class="btn btn-primary checkout_button_pre " ><i class="fa fa-arrow-left"></i> View Shipping Address</a>
                                                                            </div>
                                                                            <div class="proceed-button pull-right ">

                                                                                <a href=" <?php echo site_url("PayPalPayment".$checkoutmode."/process"); ?>" class="btn btn-primary checkout_button_next "  onclick="confirmOrder()">Place Order <i class="fa fa-arrow-right"></i></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                ...
                                                if (PAYMENT_MODE_BANK == 'on') {
                                                    ?>
                                                    <div class="  <?php echo DEFAULT_PAYMENT_MODE == 'Bank Transfer' ? 'active in' : ''; ?>" id="bank">
                                                        <p>
                                                            ...
                                                            <table class="table table-hover">
                                                                <tbody id="quantity-holder">
                                                                    <tr>
                                                                        <td colspan="4" class="text_right">
                                                                            <div class="proceed-button pull-left " >
                                                                                <a href=" <?php echo site_url("Cart/checkoutShipping"); ?>" class="btn btn-primary checkout_button_pre " ><i class="fa fa-arrow-left"></i> View Shipping Address</a>
                                                                            </div>
                                                                            <div class="proceed-button pull-right ">
                                                                                <button type="submit" name="place_order" class="btn btn-primary checkout_button_next "  value="Bank Transfer" onclick="confirmOrder()">
                                                ...
                                                if (PAYMENT_MODE_COD == 'on') {
                                                    ?>
                                                    <div class="  <?php echo DEFAULT_PAYMENT_MODE == 'Cash On Delivery' ? 'active in' : ''; ?>" id="cash">
                                                        <p>
                                                                ...
                                                                <tbody id="quantity-holder">
                                                                    <tr>
                                                                        <td colspan="4" class="text_right">
                                                                            ...
                                                                            <div class="proceed-button pull-right ">
                                                                                <button type="submit" name="place_order" class="btn btn-primary checkout_button_next "  value="Cash On Delivery">
                                                                                    Place Order <i class="fa fa-arrow-right"></i>
                                                                                </button>                                                                  
                                                                            </div>
                                                                        </td>
                                                ...
                                                if (PAYMENT_MODE_CHEQUE == 'on') {
                                                    ?>
                                                    <div class="  <?php echo DEFAULT_PAYMENT_MODE == 'Cheque On Delivery' ? 'active in' : ''; ?>" id="cheque">
                                                        <p>
                                                                ...
                                                                <tbody id="quantity-holder">
                                                                    <tr>
                                                                        <td colspan="4" class="text_right">
                                                                            ...
                                                                            <div class="proceed-button pull-right ">
                                                                                <button type="submit" name="place_order" class="btn btn-primary checkout_button_next "  value="Cheque On Delivery">
                                                                                    Place Order <i class="fa fa-arrow-right"></i>
                                                                                </button>                                                                   
                                                                            </div>
                                                                        </td>
