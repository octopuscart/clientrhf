            ...
            <div class="row"  style="border-bottom: 2px solid;    background: #ffffffb8; ">
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active col-md-6 media">
                            ...
                            <a href="#aus_appointment" aria-controls="aus_appointment" role="tab" data-toggle="tab">
                        ...
                        <li role="presentation" class="col-md-6">
                            <a href="#usa_appointment" aria-controls="usa_appointment" role="tab" data-toggle="tab">
                                <h2 class="title-sidebar text-center" style="margin: 15px;padding-bottom:  15px;border-bottom: 1px dotted ;    width: 100%;">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="aus_appointment">
                            <?php
                                ...
                                <table class="table table-borderd">
                                    ...
                                    foreach ($appointmentdata as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo ucfirst(strtolower($value['city_state'])); ?>
                                            </td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="usa_appointment">
                            <?php
                                ...
                                <table class="table table-borderd">
                                    ...
                                    foreach ($appointmentdatausa as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo ucwords(strtolower($value['city_state'])); ?>
                                            </td>
