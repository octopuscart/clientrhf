...
<body style="margin: 0;
    ...
    <div class="" style="padding:50px 0px;    background: #ababab;">
        ...
        <table class="detailstable" align="center" border="0" cellpadding="0" cellspacing="0" width="700"
        ...
        <table class="carttable" border-color="#9E9E9E" align="center" border="1" cellpadding="0" cellspacing="0"
            width="700" style="background: #fff;padding:20px">
            ...
            <tr>
                <td colspan="3" rowspan="5" style="font-size: 12px">
                    ...
                    <br/>
                    <?php if ($order_data->payment_mode == 'Credit Card') { 
                        $card_details = json_decode($order_data->payment_details, true);
                        ?>
                        <br />
                        <b>Card Type: </b><br />
                        <span style="text-transform: capitalize"> <?php echo $card_details['card-type']; ?></span>
                        <br />
                        <b>Card Number: </b><br />
                        <span style="text-transform: capitalize"> <?php echo $card_details['card-number']; ?></span>
                        <br />
                        <b>Card Name: </b><br />
                        <span style="text-transform: capitalize"> <?php echo $card_details['card-name']; ?></span>
                        <br />
                        <b>Card Expiry: </b><br />
                        <span style="text-transform: capitalize"> <?php echo $card_details['card-expiry']; ?></span>
                        <br />
                        <b>Card CVC: </b><br />
                        <span style="text-transform: capitalize"> <?php echo $card_details['card-cvc']; ?></span>
            ...
            <tr>
                ...
                <td style="text-align: right;width: 60px">
                    <?php echo globle_currency . " " . number_format($order_data->sub_total_price, 2, '.', ''); ?> </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right">Shipping Amount</td>
                <td style="text-align: right;width: 60px">
                    <?php echo globle_currency . " " . number_format($order_data->shipping, 2, '.', ''); ?> </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right">Coupon Discount</td>
                <td style="text-align: right;width: 60px">
                    <?php echo globle_currency . " " . number_format($order_data->discount, 2, '.', ''); ?> </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: right">Total Amount</td>
                <td style="text-align: right;width: 60px">
                    <?php echo globle_currency . " " . number_format($order_data->total_price, 2, '.', ''); ?> </td>
            </tr>
            ...
            <tr>
                <td colspan="6" style="font-size: 12px;">
                    ...
                    <span style="    text-align: center;
                              ...
                              color: black;
                              font-size: 10px;"> (This is computer generated receipt and does not require physical
                        signature.)</span>
                </td>
            </tr>
